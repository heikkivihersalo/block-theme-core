...
class AdminPagesManager {
	...
	public function __construct() {
		$this->pages = array(
			array(
				'slug' => 'general',
				'name' => __( 'General', 'vihersalo-block-theme-core' ),
			),
			array(
				'slug' => 'analytics',
				'name' => __( 'Analytics', 'vihersalo-block-theme-core' ),
			),
			array(
				'slug' => 'contact',
				'name' => __( 'Contact', 'vihersalo-block-theme-core' ),
			),
			array(
				'slug' => 'social-media',
				'name' => __( 'Social Media', 'vihersalo-block-theme-core' ),
			),
		);
	}
	...
	public function setup_theme_options(): void {
		 ...
		 */
		add_menu_page(
			__( 'Kotisivu Theme Options', 'vihersalo-block-theme-core' ), // Page Title
			__( 'Kotisivu Theme', 'vihersalo-block-theme-core' ), // Menu Title
