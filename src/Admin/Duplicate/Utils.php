...
final class Utils {
     ...
     */
    public static function addDuplicatePostLinkToAdmin(array $actions, WP_Post $post): array {
     ...
     * @return void
     */
    public static function createDuplicatePostAsDraft(): void {
     ...
     * @return void
     */
    public static function showDuplicateAdminNotice(): void {
