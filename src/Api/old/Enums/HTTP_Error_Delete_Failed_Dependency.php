 ...
 * @since      1.0.0
 *
 * @package    Vihersalo\Core\Theme\Api\Enums\HTTP_Error_Delete_Failed_Dependency
 */
...
enum HTTP_Error_Delete_Failed_Dependency implements HTTP_Response_Interface {
	...
	public function values(): array {
		return match ( $this ) {
			self::GENERIC => [
				'message'     => __( 'Failed to delete resource because of dependency.', 'Vihersalo-block-theme-core' ),
